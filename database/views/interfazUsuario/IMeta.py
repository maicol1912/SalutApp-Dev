...
def formulario(request):
    ...
    **Template:**
    ...
    :template:`database/interfazUsuario/registrarUsuario.html`
    """
    return render(request, 'database/interfazUsuario/registrarUsuario.html')
...
def ingresar(request):
    ...
    try:
        if request.method == "POST":
                ...
                if (Usuario.objects.get(usuario_nombre = user) or Usuario.objects.get(usuario_nombre = user)):
